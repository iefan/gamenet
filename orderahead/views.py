...
def selectorder(request, name="", phone=""):
    curppname = [u"姓名", u"性别", u"年龄", u"地址", u"电话", u"人数", u"预订时间", u"是否通过申请"]
    curpp     = ["","","","","","","",""]
    if request.method == 'POST':
        ...
        try:
            ...
            if curpp.isagree:
                ...
                isagree = u"未通过"
            curpp = [curpp.name, curpp.sex, curpp.age, curpp.address, curpp.phone, curpp.personnums, tmpdatetime, isagree]
